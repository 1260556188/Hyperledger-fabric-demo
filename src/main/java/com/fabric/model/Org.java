...
public class Org {
    ...
    public String getTls_ca_cert() {
		return tls_ca_cert;
	}



	public void setTls_ca_cert(String tls_ca_cert) {
		this.tls_ca_cert = tls_ca_cert;
	}
    ...
    public UserContext getPeerAdmin() {
        return peerAdmin;
    }

    public void setPeerAdmin(UserContext peerAdmin) {
	...
	public String toString() {
		return "Org [name=" + name + ", mspid=" + mspid + ", caClient=" + caClient + ", userMap=" + userMap
				+ ", peerLocations=" + peerLocations + ", ordererLocations=" + ordererLocations + ", eventHubLocations="
				+ eventHubLocations + ", peers=" + peers + ", orderers=" + orderers + ", admin=" + admin
				+ ", caLocation=" + caLocation + ", tls_ca_cert=" + tls_ca_cert + ", caProperties=" + caProperties
				+ ", peerAdmin=" + peerAdmin + ", domainName=" + domainName + "]";
	}
